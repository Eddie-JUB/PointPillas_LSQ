...
def main(args):
    ...
    data_dir = "/home/AI_system_design/PointPillars/"

    with open(data_dir+'config.yaml') as yaml_file:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', default='//home/dataset/kitti', 
